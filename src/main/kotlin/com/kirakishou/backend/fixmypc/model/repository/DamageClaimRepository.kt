...
interface DamageClaimRepository {
    ...
    fun findMany(isActive: Boolean, ownerId: Long, offset: Long, count: Long): List<DamageClaim>
    fun findMany(isActive: Boolean, idsToSearch: List<Long>): List<DamageClaim>
