...
data class CreateDamageClaimRequest(@SerializedName(Constant.SerializedNames.DAMAGE_CATEGORY) val category: Int,
                                    ...
                                    @SerializedName(Constant.SerializedNames.LOCATION_LON) val lon: Double)